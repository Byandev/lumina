        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <div className="flex items-center gap-x-2">
                    <CircularProgress percentage={(row.original.onboarding_percentage ?? 0) * 100} size={20}/>

                    <span>{ percentageFormatter(row.original.onboarding_percentage ?? 0) }</span>
                </div>
            }
        },
        {
            ...
            cell: ({ row }) => <StatusBadge status={row.original.notarization_status as string} />
        },
        {
            ...
            cell: ({ row }) => <StatusBadge status={row.original.erp_status as string} />
        },
        {
            ...
            cell: ({ row }) => <StatusBadge status={row.original.sales_activity as string} />
        },
        {
            accessorKey: 'level',
            header: ({ column }) => (
            ...
            cell: ({ row }) => <StatusBadge status={row.original.level as string} />
        }
    ];
