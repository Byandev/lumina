...
import { AlertTriangle, CheckCircle, File, Plus, Target } from 'lucide-react';
...
export interface PerformanceRecord {
    ...
    attachment_path_url: string | null;
        ...
        <CompanyLayout company={company}>
            <div className="rounded-xl border border-gray-200 bg-white p-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link
                        href={`/companies/${company.id}/performance-records/add-record`}
                    >
                        <Button>
                ...
                {!records.data.length ? (
                    <div className="rounded-lg border bg-white p-6 text-center">
                        ...
                        <Link
                            href={route(
                                'companies.performance-records.create',
                                company.id,
                            )}
