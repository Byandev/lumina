...
import SectionHeader from '@/components/ui/SecctionHeader';
                        ...
                        <div className="sticky bottom-0 -mx-4 mt-8 border-t border-zinc-200 bg-white/80 px-4 py-4 backdrop-blur">
                            <div className="mx-auto flex w-full max-w-5xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <div className="flex gap-3">
                                    <Link
                                        href="/"
                                        className="inline-flex h-11 items-center justify-center rounded-xl border border-zinc-200 bg-white px-5 text-sm font-medium text-zinc-700 hover:border-zinc-300 hover:text-zinc-900"
                                    >
                                        Cancel
                                    </Link>
